...
| `redup`                                     | Manual, opt-in refresh of fast-moving offensive tools (nuclei engine+templates, katana, searchsploit exploit-DB) — attacker box only, never mid-engagement; apt-packaged tools update via `up` |
